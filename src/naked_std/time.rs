...
// NOTE: Replace with crate::sync::Mutex once implemented
pub use spin::Mutex;
...
impl Instant {
    ...
    pub fn now() -> Instant {
        ...
        // NOTE: Remove and implement sys mutex
...
mod tests {
    ...
    #[unittest]
    fn instant_math() {
        // These unittests would panic because the system has been alive for milis not secs
        let a = Instant::now();
        let b = Instant::now();
        println!("a: {:?}", a);
        println!("b: {:?}", b);
    ...
    #[unittest]
    #[should_panic] // NOTE: should_panic hasnt yet been implemented in the proc macro so skip this one;
