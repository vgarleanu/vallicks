...
use crate::naked_std::sync::atomic::{AtomicBool, AtomicIsize, AtomicUsize, Ordering};
use crate::naked_std::sync::mpsc::blocking::{self, SignalToken};
use crate::naked_std::sync::mpsc::spsc_queue as spsc;
use crate::naked_std::sync::mpsc::Receiver;
...
impl<T> Packet<T> {
    ...
    pub fn recv(&self) -> Result<T, Failure<T>> {
